...
const Note = ({ editValue, width, height }) => {
	...
	var toolbarOptions = [['bold', 'italic', 'underline'], [{ link: true }], [{ list: 'ordered' }, { list: 'bullet' }], ['clean']];
	const { quill, quillRef, Quill } = useQuill({ modules: { magicUrl: true, toolbar: toolbarOptions } });
	// Idioma
